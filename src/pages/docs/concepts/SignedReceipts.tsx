...
## Trust hierarchy
1. signed-receipt — full attestation, fully verifiable (canonical trust model)
...
signed-receipt is the recommended and default attestation mode.
...
const SignedReceipts = () => (
  ...
  "signatureB64Url": "MEUCIQD3..."
    ...
    <ul>
      ...
      <li><strong>attestorKeyId</strong> — identifies which signing key was used.</li>
      <li><strong>signature</strong> — raw Ed25519 signature over the canonical receipt payload.</li>
      <li><strong>signatureB64Url</strong> — base64url encoding of the signature, used for transport and storage.</li>
    </ul>
...
https://verify.nexart.io/c/sha256%3A7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069`}
    ...
    <p>Nodes publish their public keys at a well-known endpoint. The <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">attestorKeyId</code> in the receipt tells you which key to use for verification.</p>
    <CodeBlock

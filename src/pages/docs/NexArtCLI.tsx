...
const NexArtCLI = () => (
  <>
    ...
    <p>
      As of <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">@nexart/cli@0.11.0</code>,
...
# integrity: PASS, receipt: PASS, envelope: PASS`}
    ...
    <h2>Installation</h2>
    <CodeBlock code={`npx @nexart/cli@0.11.0 --help`} title="Install / Help" />
    ...
    <p>
      ...
      as defined by <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">@nexart/ai-execution@0.22.0</code>:
    </p>
    <CodeBlock
      language="json"
  ...
  "output": {
    ...
    <h3>Command</h3>
    <CodeBlock code={`npx @nexart/cli@0.11.0 ai seal execution.json --out cer.json`} title="Seal a CER" />
  ...
  "cli": {
    ...
    <CodeBlock code={`npx @nexart/cli@0.11.0 ai certify execution.json --out cer.certified.json`} title="Certify" />
    <CodeBlock
      code={`CER certified
...
npx @nexart/cli@0.11.0 ai verify cer.certified.json`} />
    ...
    <CodeBlock code={`npx @nexart/cli@0.11.0 ai seal    execution.json --signals-file signals.json
npx @nexart/cli@0.11.0 ai certify execution.json --signals-file signals.json`} title="With Signals" />
    <p>

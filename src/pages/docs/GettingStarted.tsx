...
const GettingStarted = () => {
  return (
    <>
      ...
      <ul>
        <li><a href="https://verify.nexart.io" target="_blank" rel="noopener noreferrer">verify.nexart.io</a> is the public verification portal.</li>
        <li><a href="https://node.nexart.io" target="_blank" rel="noopener noreferrer">node.nexart.io</a> is the public identity surface of the NexArt attestation node.</li>
        <li><code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">node.nexart.io/.well-known/nexart-node.json</code> publishes signing keys used for independent verification.</li>
      </ul>

...
const CERProtocol = () => (
  ...
  "checks": {
    ...
    <h2 id="record-management">Record Management Layer</h2>
    <p>Lifecycle management, archival behavior, and record actions (hide, delete, revoke, export) are defined separately in the <a href="/docs/cer-record-management" className="text-primary hover:underline">CER Record Management</a> documentation.</p>
    <p>These concepts operate at the storage, visibility, and governance layer and do not modify the CER bundle, <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">certificateHash</code>, or verification semantics.</p>

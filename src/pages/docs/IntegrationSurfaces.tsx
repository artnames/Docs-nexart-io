...
const IntegrationSurfaces = () => (
  <>
    ...
    <p>The command-line interface for creating, certifying, and verifying CERs, plus deterministic rendering. As of v0.7.0, <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">nexart ai verify</code> accepts both raw CER bundles and CER packages.</p>

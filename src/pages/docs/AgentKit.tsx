...
const AgentKit = () => (
  <>
    ...
    <p className="text-sm text-muted-foreground">Current version: 0.5.3</p>
...
// bundle.integrity.projectHash is the verifiable hash`}
    ...
    <div className="not-prose my-6 rounded-lg border border-border bg-muted/30 p-4">
      ...
      <div className="text-sm text-muted-foreground">
        agent-kit v0.5.3 handles simple linear workflows. For complex DAGs or non-linear execution graphs, use the lower-level SDK helpers (<code className="bg-muted px-1 py-0.5 rounded text-xs font-mono">certify</code> + <code className="bg-muted px-1 py-0.5 rounded text-xs font-mono">createProjectBundle</code>).
      </div>
    </div>

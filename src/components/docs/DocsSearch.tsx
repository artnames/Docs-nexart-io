...
const searchIndex: SearchEntry[] = [
  ...
  { title: "CER Record Management", path: "/docs/cer-record-management", section: "Protocol", keywords: "CER record management lifecycle active archived hidden deleted revoke export hide audit retention policy retention classes legal hold expiry governance operational sensitive actions governance controls trust posture" },

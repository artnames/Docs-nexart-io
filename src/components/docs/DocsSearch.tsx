...
const searchIndex: SearchEntry[] = [
  ...
  { title: "AI Execution CER", path: "/docs/ai-execution", section: "Core Concepts", keywords: "ai execution cer certificateHash scope determinism verifiability executionId not unique identifier signals optional snapshot model inputHash outputHash" },
  { title: "Verification Semantics", path: "/docs/verification-semantics", section: "Verification", keywords: "verification semantics reseal redacted public hash original certificateHash signals scope hash bound supplemental result classes pitfalls executionId not identifier" },
  { title: "Project Bundle Registration", path: "/docs/project-bundle-registration", section: "Verification", keywords: "project bundle registration register node /v1/project-bundle/register projectHash public verification path B multi-step workflow registerProjectBundle endpoint receipt idempotent" },
  { title: "Verification Statuses & Errors", path: "/docs/verification-statuses-and-errors", section: "Verification", keywords: "verification statuses errors troubleshooting NOT_FOUND VERIFIED FAILED supplemental CONTEXT_NOT_PROTECTED CERTIFICATE_HASH_MISMATCH HASH_MISMATCH PERSISTENCE_FAILED AUTH_INVALID local pass public not found cheatsheet" },
  { title: "Multi-step & Multi-agent Workflows", path: "/docs/multi-step-and-multi-agent-workflows", section: "Verification", keywords: "multi step multi agent workflows project bundle agent handoff tool boundary linear non-linear branching parallel step CER projectHash agent kit" },
  { title: "Public Reseals & Redacted Verification", path: "/docs/public-reseals-and-redacted-verification", section: "Verification", keywords: "public reseal redacted verification new certificateHash original provenance signed-redacted-reseal requested hash returned public hash privacy verifier" },
  ...
  { title: "Signals SDK", path: "/docs/signals-sdk", section: "Developer Tools", keywords: "signals SDK @nexart/signals createContext createSignalCollector createExecutionContext hashSignals validateSignals diffSignals exportContext importContext compareContexts assertContextDeterministic freezeContext signaturePayload summary contextHash deterministic mode lock validate findByType findByStep filter step wrap start input output tool decision certify debug print NexArtSignal canonical JSON sha256 tamper-evident replay snapshot v0.1 v0.2 v0.3 v0.4 v0.5 v0.6 v0.7 v0.8 builder DX layer" },

...
const navigation: NavItem[] = [
  ...
  { title: "Builder Integration Guide", path: "/docs/builder-integration-guide" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Verification Statuses & Errors", path: "/docs/verification-statuses-and-errors" },
      { title: "Project Bundle Registration", path: "/docs/project-bundle-registration" },
      { title: "Multi-step & Multi-agent Workflows", path: "/docs/multi-step-and-multi-agent-workflows" },
      { title: "Public Reseals & Redacted Verification", path: "/docs/public-reseals-and-redacted-verification" },

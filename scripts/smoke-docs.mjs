...
const ROUTES = {
  ...
  "/docs/verification-statuses-and-errors": "Verification Statuses & Errors",
  "/docs/multi-step-and-multi-agent-workflows": "Multi-step & Multi-agent Workflows",
  "/docs/public-reseals-and-redacted-verification": "Public Reseals & Redacted Verification",
  ...
  "/docs/confidential-mode": "Confidential Execution (Protocol 1.3.1)",

...
const ROUTE_META = {
  ...
  "/docs/codemode-sdk": { title: "CodeMode SDK", summary: "Deterministic generative execution environment for verifiable visual outputs." },
  "/docs/ui-renderer-sdk": { title: "UI Renderer SDK", summary: "Deterministic UI rendering for verifiable interface artifacts." },
